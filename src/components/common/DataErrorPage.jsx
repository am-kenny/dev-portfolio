  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-black text-white">
      <div className="text-center max-w-lg mx-auto px-4">
        <div className="mb-8">
          <div className={`mx-auto w-24 h-24 rounded-full flex items-center justify-center ${isConfigError ? 'bg-amber-500' : 'bg-red-500'}`}>
        ...
        <h1 className="text-3xl font-bold mb-4">{isConfigError ? 'Configuration Error' : 'Data not available'}</h1>
        ...
        {isConfigError && (
          <div className="text-left mb-8 p-4 bg-gray-800/50 rounded-lg border border-gray-700">
            <p className="text-sm text-gray-400">
              Check your <code className="text-amber-400">.env</code> file and ensure the variables for the selected data source are set. See <code className="text-amber-400">.env.example</code> for reference.
            </p>
          </div>
        )}
