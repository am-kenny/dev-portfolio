...
const SkillsConfigForm = ({
  ...
  const handleHierarchicalSkillChange = (cat, subcat, idx, field, value) => {
    setCategories({
      ...
      [cat]: {
        ...categories[cat],
        [subcat]: categories[cat][subcat].map((s, i) =>
          i === idx ? { ...s, [field]: value } : s
        ),
      },
    })
  ...
  const handleConfirmAddSubcategory = (cat) => {
    if (newSubcategory && newSubcategory.trim()) {
      ...
      if (
        categories[cat] &&
        typeof categories[cat] === 'object' &&
        categories[cat][trimmedSubcategory]
      ) {
        setError(
            ...
            <div className="mt-3 p-3 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-md">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onKeyPress={(e) =>
                    e.key === 'Enter' && handleConfirmAddSubcategory(cat)
                  }
                  autoFocus
                />
                <button
      ...
      {!disabled && (
        <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-md p-4 mb-4">
          ...
          <div className="text-sm text-blue-700 dark:text-blue-300 space-y-1">
            ...
            <p>
              • <strong>Convert:</strong> Use "Convert to Subcategories" to
              organize flat categories
            </p>
            <p>
