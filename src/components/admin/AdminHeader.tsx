...
const AdminHeader = ({ onLogout }: AdminHeaderProps): JSX.Element => {
  return (
    <header className="sticky top-0 z-10 bg-white/80 dark:bg-gray-900/80 backdrop-blur shadow-sm py-6 px-4 sm:px-8 flex flex-col sm:flex-row items-center justify-between border-b border-gray-200 dark:border-gray-700">
      <div>
