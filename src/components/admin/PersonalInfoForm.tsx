...
const PersonalInfoForm = ({
  ...
  const inputClass = disabled
    ...
    : 'w-full border border-gray-200 dark:border-gray-600 rounded px-3 py-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-400 dark:focus:border-blue-400'

  return (
    <form
      onSubmit={handleSubmit}
      className={disabled ? 'space-y-4' : 'space-y-4'}
    >
      <div>
